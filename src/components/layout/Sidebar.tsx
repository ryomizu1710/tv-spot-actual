...
export function Sidebar() {
  return (
    <aside className="flex w-[220px] flex-col border-r border-black/[0.06] bg-[#f0f0f5]/90 backdrop-blur-xl">
      ...
      <div className="border-t border-black/[0.06] px-5 py-4 text-[11px] text-[#86868b]">
